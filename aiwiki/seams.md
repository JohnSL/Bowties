...
- **Last-modified**: 2026-07-07 (Spec 020 / S1 — compile-before-compose pattern added; `logic_adapter/` + `logicAdapter.ts` + `logic_adapter.rs` IPC added as Contributors; logic allocation stored as per-facility field in `facilitiesStore` per D3 — no new dirty bucket)
- **Last-audited**: 2026-07-07

    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            if let Some(window) = app.get_webview_window("main") {
                ...
                // Window close is coordinated by the frontend: the
                // onCloseRequested JS listener shows an unsaved-changes
                // dialog when needed, then calls disconnect_lcc and
                // appWindow.close().  No backend close interception needed.
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_layout_with_bus_writes,  // Spec 013: three-phase save with bus writes

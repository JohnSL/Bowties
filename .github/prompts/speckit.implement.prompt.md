...
1. **Prior work**: Search `specs/ideas/` for idea files with area tags matching this feature. Surface any relevant prior analysis or deferred decisions that affect scope.

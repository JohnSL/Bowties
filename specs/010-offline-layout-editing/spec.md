...
- The new layout schema version is backward-incompatible with the current Feature 009 single-file format for node snapshots, but the app can still open older layout files (treating them as having no captured node data).
